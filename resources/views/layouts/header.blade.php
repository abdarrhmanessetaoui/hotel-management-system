<div class="container-fluid bg-dark px-0 sticky-top" style="z-index:1030;">
    <div class="row gx-0">
        ...
        <div class="col-lg-10">
            ...
            {{-- Navbar --}}
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-lg-0"
                 style="padding:4px 10px !important;">

                {{-- Mobile logo --}}
                <a href="{{ route('home') }}"
                   class="navbar-brand d-block d-lg-none m-0"
                ...
                <button type="button"
                        ...
                        style="padding:2px 4px; width:28px; height:45px;"
                        data-bs-toggle="collapse"
                        data-bs-target="#navbarCollapse">
                    <span class="navbar-toggler-icon"
                          style="width:16px; height:16px; background-size:100%;"></span>
                </button>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav py-0" id="main-nav">
                        ...
                        <a class="nav-item nav-link px-3"
                           data-section="team"
                           href="{{ route('home') }}#team">Contact</a>
                    </div>
                    ...
                    <div class="navbar-nav py-0 auth-nav pe-1">
                        ...
                        @else
                            <div class="nav-item dropdown">
                                <button class="nav-btn-solid dropdown-toggle border-0"
...
.nav-btn-solid:hover,
.nav-btn-outline:hover { opacity: .82; }
