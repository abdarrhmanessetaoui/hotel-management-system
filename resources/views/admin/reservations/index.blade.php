        ...
        <div class="card-body p-0">
            <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                    ...
                    <tr>
                        ...
                        <td class="fw-bold py-3 text-nowrap">
                            ...
                            @if(isset($reservation->room->type))
                                <span class="text-muted small fw-normal ms-1">({{ ['single'=>'Simple','double'=>'Double','suite'=>'Suite','deluxe'=>'Luxe'][$reservation->room->type] ?? ucfirst($reservation->room->type) }})</span>
                            @endif
                        </td>
                        ...
                        <td class="fw-bold text-nowrap" style="color: #FEA116;">{{ $reservation->total_price !== null ? number_format($reservation->total_price,2).' MAD' : '-' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="9">
                            <p class="text-primary fw-bold mb-0 ps-4 py-3">Aucune réservation trouvée pour cet hôtel.</p>
                        </td>
                    </tr>
                @endforelse
                </tbody>
